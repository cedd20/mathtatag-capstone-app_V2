...
export default function Quarter4Homepage() {
  ...
  const handlePlay = async () => {
    // Map navigation based on selected week for Quarter 4
    const mapRoutes = [
  ...
  // Language-aware text
  const t = {
    welcome: isEnglish ? 'Welcome to Quarter 4!' : 'Maligayang pagdating sa Quarter 4!',
