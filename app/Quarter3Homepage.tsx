...
export default function Quarter3Homepage() {
  ...
  const handlePlay = async () => {
    // Map navigation based on selected week for Quarter 3
    const mapRoutes = [
      '/Map5Stages',   // Week 1 → Map5
      '/Map6Stages',   // Week 2 → Map6
      '/Map7Stages',   // Week 3 → Map7
      '/Map8Stages',   // Week 4 → Map8
      '/Map9Stages',   // Week 5 → Map9
      '/Map10Stages',  // Week 6 → Map10
      '/Map11Stages',  // Week 7 → Map11
      '/Map12Stages',  // Week 8 → Map12
    ];
  ...
  // Language-aware text
  const t = {
    welcome: isEnglish ? 'Welcome to Quarter 3!' : 'Maligayang pagdating sa Quarter 3!',
