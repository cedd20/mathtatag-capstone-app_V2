...
const Level6Game: React.FC<Level6GameProps> = ({ onComplete, onExit }) => {
  ...
  const defaultElements = useMemo(() => [
    {
      ...
      height: 100,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/Ken.png'),
      name: 'Ken',
      emoji: '🟫🟫🟫🟫'
    },
    {
      ...
      height: 100,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/Blessie.png'),
      name: 'Blessie',
      emoji: '🟫🟫🟫🟫🟫🟫🟫'
    },
    {
      ...
      height: 100,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/Marga.png'),
      name: 'Marga',
      emoji: '🟫🟫🟫🟫🟫🟫🟫🟫🟫'
    }
  ], []);
  ...
  return (
    <ImageBackground 
      source={require('../../../assets/Quarter 2/Week 1/bgLevel6.png')} 
