...
const Level1Game: React.FC<Level1GameProps> = ({ onComplete, onExit }) => {
  ...
  const defaultElements = useMemo(() => [
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/lapis.png'),
      name: 'Lapis',
      emoji: '✏️'
    },
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/ruler.png'),
      name: 'Ruler',
      emoji: '📏'
    },
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/gunting.png'),
      name: 'Gunting',
      emoji: '✂️'
    },
    {
      ...
      height: 100,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/pot.png'),
      name: 'Pot',
      emoji: '🏺'
    }
  ], []);
  ...
  return (
    <ImageBackground 
      source={require('../../../assets/Quarter 2/Week 1/bgLevel1 (2).png')} 
