...
const Level4Game: React.FC<Level4GameProps> = ({ onComplete, onExit }) => {
  ...
  const elementAnimations = useRef<{[key: number]: Animated.Value}>({
    1: new Animated.Value(1), // 3 rocks
    2: new Animated.Value(1), // 2 rocks
    3: new Animated.Value(1), // 4 rocks
    4: new Animated.Value(1), // 5 rocks
  }).current;
  ...
  const defaultElements = useMemo(() => [
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/p3.png'), // Using Week 1 assets as placeholder
      name: 'Tatlong bato',
      emoji: '🪨🪨🪨'
    },
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/p2.png'), // Using Week 1 assets as placeholder
      name: 'Dalawang bato',
      emoji: '🪨🪨'
    },
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/p4.png'), // Using Week 1 assets as placeholder
      name: 'Apat na bato',
      emoji: '🪨🪨🪨🪨'
    },
    {
      ...
      height: 80,
      scale: 1,
      image: require('../../../assets/Quarter 2/Week 1/p5.png'), // Using Week 1 assets as placeholder
      name: 'Limang bato',
      emoji: '🪨🪨🪨🪨🪨'
    }
  ], []);
  ...
  const correctAnswer = 4; // 5 rocks is the heaviest
  ...
  const saveLayout = async () => {
    try {
      ...
      await AsyncStorage.setItem('week2_level4_layout', JSON.stringify(layoutData));
  ...
  const loadSavedLayout = async () => {
    try {
      ...
      const savedLayout = await AsyncStorage.getItem('week2_level4_layout');
  ...
  const clearSavedLayout = async () => {
    try {
      await AsyncStorage.removeItem('week2_level4_layout');
  ...
  return (
    <ImageBackground 
      source={require('../../../assets/Quarter 2/Week 1/bgLevel4.png')} // Placeholder - will be updated with Week 2 assets
      style={styles.container} 
      resizeMode="cover"
    >
      <View style={styles.header}>
        <Text style={styles.title}>Level 4: Pinakamabigat na Set ng Bato</Text>
      ...
      {!showQuestion ? (
        <View style={styles.instructionContainer}>
          <Text style={styles.instruction}>
            Nagdugtong si Ana ng ilang bato para sukatin ang bigat ng kahon nila sa bahay. Ngayon ay may apat na set ng bato na magkaiba ang bilang.
          </Text>
          <Text style={styles.question}>
            Alin sa mga ito ang pinakamabigat kung ipagdudugtong-dugtong ang mga bato?
          </Text>
