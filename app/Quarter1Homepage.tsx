...
export default function Quarter1Homepage() {
  ...
  const handlePlay = async () => {
    // Map navigation based on selected week for Quarter 1
    const mapRoutes = [
      '/Map5Stages',   // Week 1 → Map1
      '/Map2Stages',   // Week 2 → Map2
      '/Map3Stages',   // Week 3 → Map3
      '/Map4Stages',   // Week 4 → Map4
      '/Map1Stages',   // Week 5 → Map5
  ...
  // Language-aware text
  const t = {
    welcome: isEnglish ? 'Welcome to Quarter 1!' : 'Maligayang pagdating sa Quarter 1!',
