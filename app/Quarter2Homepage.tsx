...
export default function Quarter2Homepage() {
  ...
  const handlePlay = async () => {
    // Map navigation based on selected week for Quarter 2
    const mapRoutes = [
      '/Map1Stages',   // Week 1 → Map1 (swapped from Week 5)
      '/Map10Stages',  // Week 2 → Map10
      '/Map11Stages',  // Week 3 → Map11
      '/Map12Stages',  // Week 4 → Map12
      '/Map9Stages',   // Week 5 → Map9 (swapped from Week 1)
      '/Map2Stages',   // Week 6 → Map2
      '/Map3Stages',   // Week 7 → Map3
      '/Map4Stages',   // Week 8 → Map4
    ];
  ...
  // Language-aware text
  const t = {
    welcome: isEnglish ? 'Welcome to Quarter 2!' : 'Maligayang pagdating sa Quarter 2!',
